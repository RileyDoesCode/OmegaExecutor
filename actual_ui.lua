...
if _G.is_omegaandroid_loaded then
    print("Omega is Already Running")
    return
end

_G.is_omegaandroid_loaded = true
...
-- StarterGui.OmegaGui.KeySystem
G2L["2"] = Instance.new("Folder", G2L["1"]);
G2L["2"]["Name"] = [[KeySystem]];

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideFrame
...
G2L["5"]["Image"] = [[rbxassetid://99733751052578]];
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideFrame.Logo.UIAspectRatioConstraint
G2L["6"] = Instance.new("UIAspectRatioConstraint", G2L["5"]);
G2L["6"]["AspectRatio"] = 0.9946909546852112;

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideFrame.Frame
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideFrame.Frame.UICorner
G2L["8"] = Instance.new("UICorner", G2L["7"]);
G2L["8"]["CornerRadius"] = UDim.new(0.09000000357627869, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideTextbox
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideTextbox.MainTextBox
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideTextbox.MainTextBox.UICorner
G2L["b"] = Instance.new("UICorner", G2L["a"]);
G2L["b"]["CornerRadius"] = UDim.new(0.09000000357627869, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.SideTextbox.UICorner
G2L["c"] = Instance.new("UICorner", G2L["9"]);
G2L["c"]["CornerRadius"] = UDim.new(0.09000000357627869, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.UICorner
G2L["d"] = Instance.new("UICorner", G2L["3"]);
G2L["d"]["CornerRadius"] = UDim.new(0.09000000357627869, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.UIAspectRatioConstraint
G2L["e"] = Instance.new("UIAspectRatioConstraint", G2L["3"]);
G2L["e"]["AspectRatio"] = 3.0439562797546387;

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue.TextButton
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue.TextButton.UICorner
G2L["11"] = Instance.new("UICorner", G2L["10"]);
G2L["11"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue.TextButton.LocalScript
G2L["12"] = Instance.new("LocalScript", G2L["10"]);


-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue.TextButton.UITextSizeConstraint
G2L["13"] = Instance.new("UITextSizeConstraint", G2L["10"]);
G2L["13"]["MaxTextSize"] = 14;

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue.UICorner
G2L["14"] = Instance.new("UICorner", G2L["f"]);
G2L["14"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.Continue.ImageLabel
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey.TextButton
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey.TextButton.UICorner
G2L["18"] = Instance.new("UICorner", G2L["17"]);
G2L["18"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey.TextButton.LocalScript
G2L["19"] = Instance.new("LocalScript", G2L["17"]);


-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey.TextButton.UITextSizeConstraint
G2L["1a"] = Instance.new("UITextSizeConstraint", G2L["17"]);
G2L["1a"]["MaxTextSize"] = 14;

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey.UICorner
G2L["1b"] = Instance.new("UICorner", G2L["16"]);
G2L["1b"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.GetKey.ImageLabel
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer.TextButton
...
-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer.TextButton.UICorner
G2L["1f"] = Instance.new("UICorner", G2L["1e"]);
G2L["1f"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer.TextButton.LocalScript
G2L["20"] = Instance.new("LocalScript", G2L["1e"]);


-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer.TextButton.UITextSizeConstraint
G2L["21"] = Instance.new("UITextSizeConstraint", G2L["1e"]);
G2L["21"]["MaxTextSize"] = 14;

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer.UICorner
G2L["22"] = Instance.new("UICorner", G2L["1d"]);
G2L["22"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.KeySystem.MainKeyFrame.JoinServer.ImageLabel
...
-- StarterGui.OmegaGui.MainUi
G2L["24"] = Instance.new("Folder", G2L["1"]);
G2L["24"]["Name"] = [[MainUi]];

-- StarterGui.OmegaGui.MainUi.MainFrame
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Logo
G2L["27"] = Instance.new("ImageLabel", G2L["26"]);
G2L["27"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
G2L["27"]["Image"] = [[rbxassetid://99733751052578]];
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Logo.UIAspectRatioConstraint
G2L["28"] = Instance.new("UIAspectRatioConstraint", G2L["27"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Frame
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Frame.UICorner
G2L["2a"] = Instance.new("UICorner", G2L["29"]);
G2L["2a"]["CornerRadius"] = UDim.new(0.09000000357627869, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons
G2L["2b"] = Instance.new("Folder", G2L["26"]);
G2L["2b"]["Name"] = [[Buttons]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Home
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Home.UIAspectRatioConstraint
G2L["2d"] = Instance.new("UIAspectRatioConstraint", G2L["2c"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Home.OffImage
G2L["2e"] = Instance.new("StringValue", G2L["2c"]);
G2L["2e"]["Value"] = [[rbxassetid://12731028861]];
G2L["2e"]["Name"] = [[OffImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Home.OnImage
G2L["2f"] = Instance.new("StringValue", G2L["2c"]);
G2L["2f"]["Value"] = [[rbxassetid://12731052548]];
G2L["2f"]["Name"] = [[OnImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Home.LocalScript
G2L["30"] = Instance.new("LocalScript", G2L["2c"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.MakeScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.MakeScript.UIAspectRatioConstraint
G2L["32"] = Instance.new("UIAspectRatioConstraint", G2L["31"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.MakeScript.OffImage
G2L["33"] = Instance.new("StringValue", G2L["31"]);
G2L["33"]["Value"] = [[rbxassetid://12730888709]];
G2L["33"]["Name"] = [[OffImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.MakeScript.OnImage
G2L["34"] = Instance.new("StringValue", G2L["31"]);
G2L["34"]["Value"] = [[rbxassetid://12730930487]];
G2L["34"]["Name"] = [[OnImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.MakeScript.LocalScript
G2L["35"] = Instance.new("LocalScript", G2L["31"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Minimize
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Minimize.UIAspectRatioConstraint
G2L["37"] = Instance.new("UIAspectRatioConstraint", G2L["36"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Minimize.OffImage
G2L["38"] = Instance.new("StringValue", G2L["36"]);
G2L["38"]["Value"] = [[rbxassetid://12731990314]];
G2L["38"]["Name"] = [[OffImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Minimize.OnImage
G2L["39"] = Instance.new("StringValue", G2L["36"]);
G2L["39"]["Value"] = [[rbxassetid://12731990314]];
G2L["39"]["Name"] = [[OnImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Minimize.LocalScript
G2L["3a"] = Instance.new("LocalScript", G2L["36"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Settings
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Settings.UIAspectRatioConstraint
G2L["3c"] = Instance.new("UIAspectRatioConstraint", G2L["3b"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Settings.OffImage
G2L["3d"] = Instance.new("StringValue", G2L["3b"]);
G2L["3d"]["Value"] = [[rbxassetid://12731105925]];
G2L["3d"]["Name"] = [[OffImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Settings.OnImage
G2L["3e"] = Instance.new("StringValue", G2L["3b"]);
G2L["3e"]["Value"] = [[rbxassetid://12731109653]];
G2L["3e"]["Name"] = [[OnImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Settings.LocalScript
G2L["3f"] = Instance.new("LocalScript", G2L["3b"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Scripts
...
-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Scripts.UIAspectRatioConstraint
G2L["41"] = Instance.new("UIAspectRatioConstraint", G2L["40"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Scripts.OffImage
G2L["42"] = Instance.new("StringValue", G2L["40"]);
G2L["42"]["Value"] = [[rbxassetid://12731084214]];
G2L["42"]["Name"] = [[OffImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Scripts.OnImage
G2L["43"] = Instance.new("StringValue", G2L["40"]);
G2L["43"]["Value"] = [[rbxassetid://12731089712]];
G2L["43"]["Name"] = [[OnImage]];

-- StarterGui.OmegaGui.MainUi.MainFrame.SideFrame.Buttons.Scripts.LocalScript
G2L["44"] = Instance.new("LocalScript", G2L["40"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.UICorner
G2L["45"] = Instance.new("UICorner", G2L["25"]);
G2L["45"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs
G2L["46"] = Instance.new("Folder", G2L["25"]);
G2L["46"]["Name"] = [[Tabs]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.TitleScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.TitleScript.MainTextBox
...
G2L["49"]["PlaceholderText"] = [[Title Name...]];
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.TitleScript.MainTextBox.UICorner
G2L["4a"] = Instance.new("UICorner", G2L["49"]);
G2L["4a"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.TitleScript.UICorner
G2L["4b"] = Instance.new("UICorner", G2L["48"]);
G2L["4b"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.UICorner
G2L["4d"] = Instance.new("UICorner", G2L["4c"]);
G2L["4d"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack.TextButton.UICorner
G2L["50"] = Instance.new("UICorner", G2L["4f"]);
G2L["50"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack.TextButton.LocalScript
G2L["51"] = Instance.new("LocalScript", G2L["4f"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack.UICorner
G2L["52"] = Instance.new("UICorner", G2L["4e"]);
G2L["52"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.GoBack.ImageLabel.UIAspectRatioConstraint
G2L["54"] = Instance.new("UIAspectRatioConstraint", G2L["53"]);
G2L["54"]["AspectRatio"] = 1.0000001192092896;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript.TextButton.UICorner
G2L["57"] = Instance.new("UICorner", G2L["56"]);
G2L["57"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript.TextButton.LocalScript
G2L["58"] = Instance.new("LocalScript", G2L["56"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript.UICorner
G2L["59"] = Instance.new("UICorner", G2L["55"]);
G2L["59"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.AddScript.ImageLabel.UIAspectRatioConstraint
G2L["5b"] = Instance.new("UIAspectRatioConstraint", G2L["5a"]);
G2L["5b"]["AspectRatio"] = 1.0000001192092896;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.MainTextBox
...
G2L["5c"]["PlaceholderText"] = [[Input Your Script...]];
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.MainTextBox.UICorner
G2L["5d"] = Instance.new("UICorner", G2L["5c"]);
G2L["5d"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript
G2L["5f"] = Instance.new("LocalScript", G2L["5e"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor
G2L["60"] = Instance.new("ModuleScript", G2L["5f"]);
G2L["60"]["Name"] = [[ScriptEditor]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Syntax
G2L["61"] = Instance.new("ModuleScript", G2L["60"]);
G2L["61"]["Name"] = [[Syntax]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Theme
G2L["62"] = Instance.new("ModuleScript", G2L["60"]);
G2L["62"]["Name"] = [[Theme]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.GetLines
G2L["63"] = Instance.new("ModuleScript", G2L["60"]);
G2L["63"]["Name"] = [[GetLines]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.FakeEditor
G2L["64"] = Instance.new("ModuleScript", G2L["60"]);
G2L["64"]["Name"] = [[FakeEditor]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.GetLine
G2L["65"] = Instance.new("ModuleScript", G2L["60"]);
G2L["65"]["Name"] = [[GetLine]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.TweenLibrary
G2L["66"] = Instance.new("ModuleScript", G2L["60"]);
G2L["66"]["Name"] = [[TweenLibrary]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.GetWord
G2L["67"] = Instance.new("ModuleScript", G2L["60"]);
G2L["67"]["Name"] = [[GetWord]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Lexer
G2L["68"] = Instance.new("ModuleScript", G2L["60"]);
G2L["68"]["Name"] = [[Lexer]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Suggestions
G2L["69"] = Instance.new("ModuleScript", G2L["60"]);
G2L["69"]["Name"] = [[Suggestions]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Words
G2L["6a"] = Instance.new("ModuleScript", G2L["60"]);
G2L["6a"]["Name"] = [[Words]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.TextFixer
G2L["6b"] = Instance.new("ModuleScript", G2L["60"]);
G2L["6b"]["Name"] = [[TextFixer]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.LineHighlight
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Hidden
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion.TextPadding
G2L["72"] = Instance.new("UIPadding", G2L["71"]);
G2L["72"]["Name"] = [[TextPadding]];
G2L["72"]["PaddingLeft"] = UDim.new(0, 30);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion.Icon
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion.Icon.UIAspectRatioConstraint
G2L["74"] = Instance.new("UIAspectRatioConstraint", G2L["73"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Right
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Right.BottomFade
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Lines
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Lines.BottomFade
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.AdaptSize
G2L["7a"] = Instance.new("LocalScript", G2L["75"]);
G2L["7a"]["Name"] = [[AdaptSize]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.BottomFade
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.ScriptFrame
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.ScriptFrame.UIListLayout
G2L["7e"] = Instance.new("UIListLayout", G2L["7d"]);
G2L["7e"]["SortOrder"] = Enum.SortOrder.LayoutOrder;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.Folder
G2L["7f"] = Instance.new("Folder", G2L["7c"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.TitleScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.TitleScript.UICorner
G2L["82"] = Instance.new("UICorner", G2L["81"]);
G2L["82"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.TitleScript.TextLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.TitleScript.TextLabel.UICorner
G2L["84"] = Instance.new("UICorner", G2L["83"]);
G2L["84"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Execute
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Execute.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Execute.TextButton.UICorner
G2L["87"] = Instance.new("UICorner", G2L["86"]);
G2L["87"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Execute.UICorner
G2L["88"] = Instance.new("UICorner", G2L["85"]);
G2L["88"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Execute.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Delete
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Delete.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Delete.TextButton.UICorner
G2L["8c"] = Instance.new("UICorner", G2L["8b"]);
G2L["8c"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Delete.UICorner
G2L["8d"] = Instance.new("UICorner", G2L["8a"]);
G2L["8d"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.Delete.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.UIAspectRatioConstraint
G2L["8f"] = Instance.new("UIAspectRatioConstraint", G2L["80"]);
G2L["8f"]["AspectRatio"] = 14.29936695098877;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.AddScript1
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.AddScript1.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.AddScript1.TextButton.UICorner
G2L["92"] = Instance.new("UICorner", G2L["91"]);
G2L["92"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.AddScript1.TextButton.LocalScript
G2L["93"] = Instance.new("LocalScript", G2L["91"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.AddScript1.UICorner
G2L["94"] = Instance.new("UICorner", G2L["90"]);
G2L["94"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.MakeScript.AddScript1.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.UICorner
G2L["98"] = Instance.new("UICorner", G2L["97"]);
G2L["98"]["CornerRadius"] = UDim.new(0.03999999910593033, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute.TextButton.UICorner
G2L["9b"] = Instance.new("UICorner", G2L["9a"]);
G2L["9b"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute.TextButton.LocalScript
G2L["9c"] = Instance.new("LocalScript", G2L["9a"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute.UICorner
G2L["9d"] = Instance.new("UICorner", G2L["99"]);
G2L["9d"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Execute.ImageLabel.UIAspectRatioConstraint
G2L["9f"] = Instance.new("UIAspectRatioConstraint", G2L["9e"]);
G2L["9f"]["AspectRatio"] = 1.0000001192092896;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear.TextButton.UICorner
G2L["a2"] = Instance.new("UICorner", G2L["a1"]);
G2L["a2"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear.TextButton.LocalScript
G2L["a3"] = Instance.new("LocalScript", G2L["a1"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear.UICorner
G2L["a4"] = Instance.new("UICorner", G2L["a0"]);
G2L["a4"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.Clear.ImageLabel.UIAspectRatioConstraint
G2L["a6"] = Instance.new("UIAspectRatioConstraint", G2L["a5"]);
G2L["a6"]["AspectRatio"] = 1.0000001192092896;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard.TextButton.UICorner
G2L["a9"] = Instance.new("UICorner", G2L["a8"]);
G2L["a9"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard.TextButton.LocalScript
G2L["aa"] = Instance.new("LocalScript", G2L["a8"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard.UICorner
G2L["ab"] = Instance.new("UICorner", G2L["a7"]);
G2L["ab"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.ExecuteClipboard.ImageLabel.UIAspectRatioConstraint
G2L["ad"] = Instance.new("UIAspectRatioConstraint", G2L["ac"]);
G2L["ad"]["AspectRatio"] = 1.0000001192092896;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript
G2L["af"] = Instance.new("LocalScript", G2L["ae"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor
G2L["b0"] = Instance.new("ModuleScript", G2L["af"]);
G2L["b0"]["Name"] = [[ScriptEditor]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Syntax
G2L["b1"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b1"]["Name"] = [[Syntax]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Theme
G2L["b2"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b2"]["Name"] = [[Theme]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.GetLines
G2L["b3"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b3"]["Name"] = [[GetLines]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.FakeEditor
G2L["b4"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b4"]["Name"] = [[FakeEditor]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.GetLine
G2L["b5"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b5"]["Name"] = [[GetLine]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.TweenLibrary
G2L["b6"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b6"]["Name"] = [[TweenLibrary]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.GetWord
G2L["b7"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b7"]["Name"] = [[GetWord]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Lexer
G2L["b8"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b8"]["Name"] = [[Lexer]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Suggestions
G2L["b9"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["b9"]["Name"] = [[Suggestions]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Words
G2L["ba"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["ba"]["Name"] = [[Words]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.TextFixer
G2L["bb"] = Instance.new("ModuleScript", G2L["b0"]);
G2L["bb"]["Name"] = [[TextFixer]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.LineHighlight
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Hidden
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion.TextPadding
G2L["c2"] = Instance.new("UIPadding", G2L["c1"]);
G2L["c2"]["Name"] = [[TextPadding]];
G2L["c2"]["PaddingLeft"] = UDim.new(0, 30);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion.Icon
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Source.Suggestion.Icon.UIAspectRatioConstraint
G2L["c4"] = Instance.new("UIAspectRatioConstraint", G2L["c3"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Right
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Right.BottomFade
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Lines
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.Lines.BottomFade
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.AdaptSize
G2L["ca"] = Instance.new("LocalScript", G2L["c5"]);
G2L["ca"]["Name"] = [[AdaptSize]];

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.LocalScript.ScriptEditor.Editor.Scroll.Left.BottomFade
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.TitleScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.TitleScript.MainTextBox
...
G2L["ce"]["PlaceholderText"] = [[Search here...]];
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.TitleScript.MainTextBox.UICorner
G2L["cf"] = Instance.new("UICorner", G2L["ce"]);
G2L["cf"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.TitleScript.UICorner
G2L["d0"] = Instance.new("UICorner", G2L["cd"]);
G2L["d0"]["CornerRadius"] = UDim.new(0.38999998569488525, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.ScriptFrame
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.ScriptFrame.UIListLayout
G2L["d3"] = Instance.new("UIListLayout", G2L["d2"]);
G2L["d3"]["SortOrder"] = Enum.SortOrder.LayoutOrder;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder
G2L["d4"] = Instance.new("Folder", G2L["d1"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.UICorner
G2L["d6"] = Instance.new("UICorner", G2L["d5"]);
G2L["d6"]["CornerRadius"] = UDim.new(0.07999999821186066, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.ImageButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.ImageButton.UICorner
G2L["d8"] = Instance.new("UICorner", G2L["d7"]);
G2L["d8"]["CornerRadius"] = UDim.new(0.07999999821186066, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.NameScript
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Credit
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Execute
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Execute.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Execute.TextButton.UICorner
G2L["dd"] = Instance.new("UICorner", G2L["dc"]);
G2L["dd"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Execute.UICorner
G2L["de"] = Instance.new("UICorner", G2L["db"]);
G2L["de"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Execute.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Execute.UIAspectRatioConstraint
G2L["e0"] = Instance.new("UIAspectRatioConstraint", G2L["db"]);
G2L["e0"]["AspectRatio"] = 3.570162534713745;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Save
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Save.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Save.TextButton.UICorner
G2L["e3"] = Instance.new("UICorner", G2L["e2"]);
G2L["e3"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Save.UICorner
G2L["e4"] = Instance.new("UICorner", G2L["e1"]);
G2L["e4"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Save.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Save.UIAspectRatioConstraint
G2L["e6"] = Instance.new("UIAspectRatioConstraint", G2L["e1"]);
G2L["e6"]["AspectRatio"] = 3.570162534713745;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.LoadText
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.LoadText.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.LoadText.TextButton.UICorner
G2L["e9"] = Instance.new("UICorner", G2L["e8"]);
G2L["e9"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.LoadText.UICorner
G2L["ea"] = Instance.new("UICorner", G2L["e7"]);
G2L["ea"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.LoadText.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.LoadText.UIAspectRatioConstraint
G2L["ec"] = Instance.new("UIAspectRatioConstraint", G2L["e7"]);
G2L["ec"]["AspectRatio"] = 3.570162534713745;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Copy
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Copy.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Copy.TextButton.UICorner
G2L["ef"] = Instance.new("UICorner", G2L["ee"]);
G2L["ef"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Copy.UICorner
G2L["f0"] = Instance.new("UICorner", G2L["ed"]);
G2L["f0"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Copy.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Copy.UIAspectRatioConstraint
G2L["f2"] = Instance.new("UIAspectRatioConstraint", G2L["ed"]);
G2L["f2"]["AspectRatio"] = 3.570162534713745;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Hide
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Hide.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Hide.TextButton.UICorner
G2L["f5"] = Instance.new("UICorner", G2L["f4"]);
G2L["f5"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Hide.UICorner
G2L["f6"] = Instance.new("UICorner", G2L["f3"]);
G2L["f6"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Hide.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.Hide.UIAspectRatioConstraint
G2L["f8"] = Instance.new("UIAspectRatioConstraint", G2L["f3"]);
G2L["f8"]["AspectRatio"] = 3.570162534713745;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.UIAspectRatioConstraint
G2L["f9"] = Instance.new("UIAspectRatioConstraint", G2L["d5"]);
G2L["f9"]["AspectRatio"] = 1.8915581703186035;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.TextButton
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.TextButton.UICorner
G2L["fc"] = Instance.new("UICorner", G2L["fb"]);
G2L["fc"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.TextButton.LocalScript
G2L["fd"] = Instance.new("LocalScript", G2L["fb"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.UICorner
G2L["fe"] = Instance.new("UICorner", G2L["fa"]);
G2L["fe"]["CornerRadius"] = UDim.new(0.4300000071525574, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.ImageLabel.UIAspectRatioConstraint
G2L["100"] = Instance.new("UIAspectRatioConstraint", G2L["ff"]);
G2L["100"]["AspectRatio"] = 1.0919350385665894;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Scripts.Search.UIAspectRatioConstraint
G2L["101"] = Instance.new("UIAspectRatioConstraint", G2L["fa"]);
G2L["101"]["AspectRatio"] = 3.4512600898742676;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.UICorner
G2L["104"] = Instance.new("UICorner", G2L["103"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.TextLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.TextBox
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.TextBox.UICorner
G2L["107"] = Instance.new("UICorner", G2L["106"]);
G2L["107"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.Set
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.Set.UICorner
G2L["109"] = Instance.new("UICorner", G2L["108"]);
G2L["109"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.Set.LocalScript
G2L["10a"] = Instance.new("LocalScript", G2L["108"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.UIAspectRatioConstraint
G2L["10b"] = Instance.new("UIAspectRatioConstraint", G2L["103"]);
G2L["10b"]["AspectRatio"] = 14.399263381958008;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.InviteLink
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.InviteLink.UICorner
G2L["10d"] = Instance.new("UICorner", G2L["10c"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.InviteLink.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.InviteLink.UIAspectRatioConstraint
G2L["10f"] = Instance.new("UIAspectRatioConstraint", G2L["10c"]);
G2L["10f"]["AspectRatio"] = 14.210898399353027;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.InviteLink.LocalScript
G2L["110"] = Instance.new("LocalScript", G2L["10c"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Credits
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Credits.UICorner
G2L["112"] = Instance.new("UICorner", G2L["111"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Credits.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Credits.UIAspectRatioConstraint
G2L["114"] = Instance.new("UIAspectRatioConstraint", G2L["111"]);
G2L["114"]["AspectRatio"] = 14.210898399353027;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Credits.LocalScript
G2L["115"] = Instance.new("LocalScript", G2L["111"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.UICorner
G2L["117"] = Instance.new("UICorner", G2L["116"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.ImageLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.UIAspectRatioConstraint
G2L["119"] = Instance.new("UIAspectRatioConstraint", G2L["116"]);
G2L["119"]["AspectRatio"] = 14.210898399353027;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.UITextSizeConstraint
G2L["11a"] = Instance.new("UITextSizeConstraint", G2L["116"]);
G2L["11a"]["MaxTextSize"] = 12;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.LocalScript
G2L["11b"] = Instance.new("LocalScript", G2L["116"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.UICorner
G2L["11d"] = Instance.new("UICorner", G2L["11c"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.TextLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.TextBox
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.TextBox.UICorner
G2L["120"] = Instance.new("UICorner", G2L["11f"]);
G2L["120"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.Set
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.Set.UICorner
G2L["122"] = Instance.new("UICorner", G2L["121"]);
G2L["122"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.Set.LocalScript
G2L["123"] = Instance.new("LocalScript", G2L["121"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.UIAspectRatioConstraint
G2L["124"] = Instance.new("UIAspectRatioConstraint", G2L["11c"]);
G2L["124"]["AspectRatio"] = 14.399263381958008;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.UICorner
G2L["126"] = Instance.new("UICorner", G2L["125"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.TextLabel
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.TextBox
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.TextBox.UICorner
G2L["129"] = Instance.new("UICorner", G2L["128"]);
G2L["129"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Set
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Set.UICorner
G2L["12b"] = Instance.new("UICorner", G2L["12a"]);
G2L["12b"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Set.LocalScript
G2L["12c"] = Instance.new("LocalScript", G2L["12a"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.UIAspectRatioConstraint
G2L["12d"] = Instance.new("UIAspectRatioConstraint", G2L["125"]);
G2L["12d"]["AspectRatio"] = 14.399263381958008;

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Reset
...
-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Reset.UICorner
G2L["12f"] = Instance.new("UICorner", G2L["12e"]);
G2L["12f"]["CornerRadius"] = UDim.new(0.699999988079071, 0);

-- StarterGui.OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Reset.LocalScript
G2L["130"] = Instance.new("LocalScript", G2L["12e"]);


-- StarterGui.OmegaGui.MainUi.MainFrame.UIAspectRatioConstraint
G2L["131"] = Instance.new("UIAspectRatioConstraint", G2L["25"]);
G2L["131"]["AspectRatio"] = 1.1973302364349365;

-- StarterGui.OmegaGui.MainUi.MainFrame.DraggableStuff
...
G2L["133"]["Image"] = [[rbxassetid://99733751052578]];
...
-- StarterGui.OmegaGui.FloatingIcon.UICorner
G2L["134"] = Instance.new("UICorner", G2L["133"]);
G2L["134"]["CornerRadius"] = UDim.new(0.25, 0);

-- StarterGui.OmegaGui.FloatingIcon.LocalScript
G2L["135"] = Instance.new("LocalScript", G2L["133"]);


-- StarterGui.OmegaGui.FloatingIcon.UIAspectRatioConstraint
...
local function C_fd()
	...
	local editor = script.Parent.Parent.Parent.TextboxBar.Editor.Scroll.Source
	local main = script.Parent.Parent.Parent

	script.Parent.Parent.Visible = false
	main.ScriptTextbox.Visible = true
	main.TitleScript.Visible = true
	main.Scripts.Visible = false
	...
	game.StarterGui:SetCore("SendNotification", {
		Title = "Omega Android";
		Text = "Script loaded into editor!";
		Duration = 3;
	})
end)
	end
...
local function C_110()
	...
	local btn = script.Parent
	btn.MouseButton1Click:Connect(function()
		setclipboard("https://discord.gg/QQTVgA7GA8")
        game.StarterGui:SetCore("SendNotification", {
    Title = "Omega Android";
    Text = "Discord Invite has been Copied To Your Clipboard.";
    Duration = 5;
    })
...
load_saved_scripts()
if isfile("theme.omega") then
    local HttpService = game:GetService("HttpService")
local json = readfile("theme.omega")
...
local gui = gethui().OmegaGui
local BG = gui.MainUi.MainFrame

BG.BackgroundColor3 = BgColor
gui.FloatingIcon.BackgroundColor3 = BgColor

    gethui().OmegaGui.MainUi.MainFrame.Tabs.MakeScript.TitleScript.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Scripts.TitleScript.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.Credits.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.InviteLink.BackgroundColor3 = MenuColor
    gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.BackgroundColor3 = MenuColor

task.spawn(function()
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.BackgroundColor3 = MenuColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.TitleScript.BackgroundColor3 = MenuColor
	for _, script in pairs(gethui().OmegaGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.ScriptFrame:GetChildren()) do
		if script.Name == "LIST" then
			script.TitleScript.BackgroundColor3 = MenuColor
		end
	end
	for _, script in pairs(gethui().OmegaGui.MainUi.MainFrame.Tabs.Scripts.Scripts.ScriptFrame:GetChildren()) do
...
task.spawn(function()
	for _, inside in pairs(gethui().OmegaGui.MainUi.MainFrame.Tabs:GetDescendants()) do
	...
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Reset.BackgroundColor3 = SettingBtnColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.Set.BackgroundColor3 = SettingBtnColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.Gravity.TextBox.BackgroundColor3 = SettingBtnColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.Set.BackgroundColor3 = SettingBtnColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.JumpPower.TextBox.BackgroundColor3 = SettingBtnColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.Set.BackgroundColor3 = SettingBtnColor
	gethui().OmegaGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.TextBox.BackgroundColor3 = SettingBtnColor
end)

if(data.editor_image ~= "") then
local ImageFile = "omega_theme_image"
local ImageTransparency = data.image_opacity
gethui().OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.Editor.Image = getcustomasset(ImageFile)
gethui().OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.Editor.Image = getcustomasset(ImageFile)
gethui().OmegaGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.Editor.ImageTransparency = ImageTransparency
gethui().OmegaGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.Editor.ImageTransparency = ImageTransparency
end
end
